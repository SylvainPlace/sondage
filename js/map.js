...
function style(feature) {
    ...
    switch (currentMode) {
        case 'avg_base': value = props.avgSalary; break;
        case 'median_base': value = props.medianSalary; break;
        case 'avg_total': value = props.avgTotal; break;
        case 'median_total': value = props.medianTotal; break;
        case 'count': value = props.count; break;
    }
    ...
    legendControl.onAdd = function (map) {
        ...
        if (currentMode === 'count') {
            ...
            for (let i = 0; i < grades.length; i++) {
                div.innerHTML +=
                    '<i style="background:' + getColorCount(grades[i] + 1) + '"></i> ' +
            ...
            for (let i = 0; i < grades.length; i++) {
                div.innerHTML +=
                    ...
                    formatMoney(grades[i]) + (grades[i + 1] ? '&ndash;' + formatMoney(grades[i + 1]) + '<br>' : '+');
            }
        }

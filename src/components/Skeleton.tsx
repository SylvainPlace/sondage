        ...
        <div className="filters-panel" style={{ marginBottom: "2rem" }}>
          ...
          >
            <div style={{ flex: 1, minWidth: "200px" }}>
              ...
              />
              <Skeleton
                style={{ height: "42px", width: "100%", borderRadius: "4px" }}
              />
            </div>
            <div style={{ flex: 1, minWidth: "200px" }}>
              <Skeleton
          ...
          <div className="filters-container-responsive">
            {[1, 2, 3, 4, 5, 6, 7].map((i) => (
              ...
              >
                ...
                />
                <Skeleton
                  style={{ height: "40px", width: "100%", borderRadius: "4px" }}
                />
              </div>
            ))}
          </div>
        ...
        <div className="stats-grid">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="stat-card">
              <Skeleton
                style={{ height: "14px", width: "60%", margin: "0 auto 8px" }}
              />
              <Skeleton
                style={{ height: "32px", width: "80%", margin: "0 auto 4px" }}
              />
              <Skeleton
